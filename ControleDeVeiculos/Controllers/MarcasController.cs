...
namespace ControleDeVeiculos.Controllers
{
    public class MarcasController : Controller
    {
        ...
        public MarcasController(ControleDeVeiculosContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name")] Marca marca)
        {
            if (id != marca.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ControleDeVeiculosContext.Marca'  is null.");
            }
            var marca = await _context.Marca.FindAsync(id);
            if (marca != null)
            {
